...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout homeFragmentLayout;

  private ActivityHomeBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomNavigationView, @NonNull FrameLayout homeFragmentLayout) {
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FrameLayout homeFragmentLayout = ViewBindings.findChildViewById(rootView, id);
